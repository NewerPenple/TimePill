...
public class RecommendInfoBean implements Serializable {
    ...
    private String CommodityUrlArr;
    private String CommodityUrlNameArr;
    ...
    public String getCommodityUrlArr() {
        return CommodityUrlArr;
    }

    public void setCommodityUrlArr(String CommodityUrlArr) {
        this.CommodityUrlArr = CommodityUrlArr;
    }

    public String getCommodityUrlNameArr() {
        return CommodityUrlNameArr;
    }

    public void setCommodityUrlNameArr(String CommodityUrlNameArr) {
